...
The testbed for this is a Raspberry Pi 4 with 4G RAM and the X001G63URN from Ozzmaker.com which provides an IMU, GPS, and the 10D0F chip.  This exposes an accelerometer, gyroscope, and a barometric sensor in addition to a GPS receiver (of course).
